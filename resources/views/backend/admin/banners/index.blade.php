    ...
    <div class="admin-content-container">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-2">
                    <div class="card-body">
                        <h2 class="admin-heading mb-1">All Banners</h2>
                        <a class="add-new pull-right ml-2" href="{{url('banner/create')}}">Add New</a>
                        <a class="btn btn-danger pull-right" href="{{url('deleted-banner')}}">Deleted Old</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table id="productsTable" class="table table-striped table-hover table-bordered">
                                    ...
                                    @foreach ($banners as $banner)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{'banner/edit/'.$banner['id']}}"><i class="btn btn-xs btn-primary fa fa-edit"></i></a>
                                                <a href="{{'banners/delete/'.$banner['id']}}" class="btn btn-xs btn-danger delete_banner"  data-id="" data-subcat=""><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php $i++ ?>
                                    @endforeach
