                            ...
                            <table id="datatable1" class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{'categorie/re-store/'.$categorie['id']}}" class="btn btn-xs btn-primary re-store_category" data-id=""><i>Re-store</i></a>
                                            <a href="{{'categorie-pr/delete/'.$categorie['id']}}" class="btn btn-xs btn-danger delete_category" data-id=""><i>Permanent Delete</i></a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                                    @endforeach
