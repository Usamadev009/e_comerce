                            ...
                            <table id="datatable1" class="table table-striped table-hover table-bordered">
                                ...
                                @foreach($subcategories as $subcategorie)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{'sub_category/re-store/'.$subcategorie['id']}}" class="btn btn-xs btn-primary re-store_subcategory" data-id=""><i >Re-store</i></a>
                                            <a href="{{'sub_category1-pr/delete/'.$subcategorie['id']}}" class="btn btn-xs btn-danger delete_subcategory" data-id=""><i>Permanent Delete</i></a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                                @endforeach
