            ...
            <div class="col-md-12">
                <div class="card  mb-3">
                    <div class="card-body">
                        ...
                        <a class="add-new pull-right ml-2" style="margin-top: -15px" href="{{url('subcategory/create')}}">Add New</a>
                        <a class="btn btn-danger pull-right" style="margin-top: -15px" href="{{url('deleted-sub-cat')}}">Deleted Old</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table id="datatable1" class="table table-striped table-hover table-bordered">
                                ...
                                @foreach($subcategories as $subcategorie)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{'subcategory/edit/'.$subcategorie['id']}}"><i class="btn btn-xs btn-primary fa fa-edit"></i></a>
                                            <a href="{{'sub_category/delete/'.$subcategorie['id']}}" class="btn btn-xs btn-danger delete_subcategorie" data-id=""><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                                @endforeach
