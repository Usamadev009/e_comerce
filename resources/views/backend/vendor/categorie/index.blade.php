            ...
            <div class="col-md-12">
                <div class="card  mb-3">
                    <div class="card-body">
                        ...
                        <a class="add-new pull-right ml-2" style="margin-top: -15px" href="{{url('vendor-categorie/create')}}">Add New</a>
                        <a class="btn btn-danger pull-right" style="margin-top: -15px" href="{{url('deleted-vendor-categorie')}}">Deleted Old</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table id="datatable1" class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{'vendor-categorie/edit/'.$categorie['id']}}"><i class="btn btn-xs btn-primary fa fa-edit"></i></a>
                                            <a href="{{'vendor-categorie/delete/'.$categorie['id']}}" class="btn btn-xs btn-danger delete_category" data-id=""><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                                    @endforeach
