                            ...
                            <table id="datatable1" class="table table-striped table-hover table-bordered">
                                ...
                                @foreach($groups as $group)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{'vendor-group/re-store/'.$group['id']}}" class="btn btn-xs btn-primary re-store_brand" data-id=""><i>Re-store</i></a>
                                            <a href="{{'vendor-group-pr/delete/'.$group['id']}}" class="btn btn-xs btn-danger delete_brand" data-id=""><i>Permanent Delete</i></a>
                                        </td>
                                    </tr>
                                <?php $i++ ?>
                                @endforeach
