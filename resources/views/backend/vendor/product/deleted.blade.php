                                ...
                                <tbody>
                                    ...
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{'vendor-product/re-store/'.$product['id']}}"><i class="btn btn-xs btn-primary re-store_product">Re-store</i></a>
                                                <a href="{{'vendor-product-pr/delete/'.$product['id']}}" class="btn btn-xs btn-danger delete_product"  data-id="" data-subcat=""><i>Permanent Delete</i></a>
                                            </td>
                                        </tr>
                                        <?php $i++ ?>
                                    @endforeach
