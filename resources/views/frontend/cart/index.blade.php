                                                    ...
                                                    <tr class="cartpage">
                                                        <td class="cart-image">
                                                            <a class="entry-thumbnail" href="javascript:void(0)">
                                                                <img src="{{ asset($data['item_image']) }}" width="70px" alt="">
                                                            </a>
                                                        </td>
                                                        ...
                                                        <td style="font-size: 20px;">
                                                            <button type="button" class="badge badge-pill badge-danger delete_cart_data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="cart-checkout-btn text-center">
                                                                    ...
                                                                    @else
                                                                        <a href="{{ route('login') }}" data-toggle="modal" data-target="#userLogin_form" class="btn btn-success btn-block checkout-btn">
                                                                            PROCCED TO CHECKOUT
                                                                        </a>
